...
def transportation_selection():
    ...
    print('The mode of transportation we have picked for you is',random_transportation, '.', 'Does that sound good for you?')
    users_choice = input('yes/no' ' ') 
    while users_choice == 'no' or users_choice == 'No' or users_choice == 'NO' or users_choice == 'n' or users_choice == 'N':
        random_transportation = random.choice(transportation_list)
        print('ok, fortunatly we have other modes of transportation available.', 'How about',random_transportation, 'instead?')
        users_choice = input('yes/no' ' ')
        if users_choice == 'yes' or users_choice == 'Yes' or users_choice == 'YES' or users_choice == 'y' or users_choice == 'Y':
            print('I am glad i could make the right choice for you!')
...
def entertainment_selection():
    ...
    print('The destination we have picked for you is',random_entertainment, '.', 'Does that sound good for you?')
    users_choice = input('yes/no' ' ') 
    while users_choice == 'no' or users_choice == 'No' or users_choice == 'NO' or users_choice == 'n' or users_choice == 'N':
        random_entertainment = random.choice(Entertainment_list)
        print('ok, fortunatly we have other locations available.', 'How about',random_entertainment, 'instead?')
        users_choice = input('yes/no' ' ')
        if users_choice == 'yes' or users_choice == 'Yes' or users_choice == 'YES' or users_choice == 'y' or users_choice == 'Y':
            print('I am glad i could make the right choice for you!')
...
def restaurant_selection():
    ...
    print('The destination we have picked for you is',random_restaurant, '.', 'Does that sound good for you?')
    users_choice = input('yes/no' ' ') 
    while users_choice == 'no' or users_choice == 'No' or users_choice == 'NO' or users_choice == 'n' or users_choice == 'N':
        random_restaurant = random.choice(Restaurants_list)
        print('ok, fortunatly we have other locations available.', 'How about',random_restaurant, 'instead?')
        users_choice = input('yes/no' ' ')
        if users_choice == 'yes' or users_choice == 'Yes' or users_choice == 'YES' or users_choice == 'y' or users_choice == 'Y':
...
def final_trip_confirmation(confirmed_destination,confirmed_transportation,confirmed_entertainment,confirmed_restaurant):
    ...
    if users_choice == 'yes' or users_choice == 'Yes' or users_choice == 'YES' or users_choice == 'y' or users_choice == 'Y':
        print('Amazing, you will be going to', confirmed_destination, '.', 'You will be traveling',confirmed_transportation, '.', 'You will be going to', confirmed_entertainment, '.', 'You will be eating at', confirmed_restaurant,'.')
